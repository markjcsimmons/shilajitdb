    ...
    <article className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-6 md:p-8 space-y-8">
        ...
        <section className="space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">What Fulvic Acid Is</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">How Fulvic Acid Works in the Body</h2>

          <h3 className="font-semibold text-slate-800 mt-4">Mineral chelation and transport</h3>
          <p>
            ...
            <a href="https://pubmed.ncbi.nlm.nih.gov/21139128/" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 text-slate-900">
              Winkler &amp; Ghosh, Environ Sci Technol 2011
            </a>
            .
          </p>

          <h3 className="font-semibold text-slate-800 mt-4">Mitochondrial support</h3>
          <p>
            ...
            <a href="https://pubmed.ncbi.nlm.nih.gov/19945408/" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 text-slate-900">
              Bhagwan S Ghosal et al., published in Int J Alzheimers Dis 2010
            </a>
            .
          </p>

          <h3 className="font-semibold text-slate-800 mt-4">Antioxidant and anti-inflammatory activity</h3>
          <p>
          ...
          <h3 className="font-semibold text-slate-800 mt-4">Cognitive and neuroprotective effects</h3>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">How Much Fulvic Acid Should a Shilajit Product Contain?</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">How Fulvic Acid Is Measured on a COA</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Fulvic Acid Supplements vs. Shilajit</h2>
          <p>
        ...
        <div className="rounded-xl border border-stone-200 bg-stone-50 p-5">
          <p className="text-sm font-medium text-slate-900">Find products with verified fulvic acid content</p>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Link href="/learn/shilajit-benefits" className="group rounded-2xl border border-stone-200 bg-white p-5 hover:border-stone-300 hover:shadow-sm transition-all">
          ...
          <p className="text-sm font-semibold text-slate-900 group-hover:text-slate-700">Shilajit Benefits: What the Evidence Supports →</p>
        </Link>
        <Link href="/learn/what-is-shilajit" className="group rounded-2xl border border-stone-200 bg-white p-5 hover:border-stone-300 hover:shadow-sm transition-all">
          <p className="text-xs text-stone-400 mb-1">Related</p>
          <p className="text-sm font-semibold text-slate-900 group-hover:text-slate-700">What Is Shilajit? Formation & Composition →</p>
        </Link>
      </div>
    </article>
  );
