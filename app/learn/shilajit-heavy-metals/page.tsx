  ...
  return (
    <>
      <ArticleSchema
        ...
        title="Shilajit and Heavy Metals: Safety, Testing & Acceptable Levels"
        description="Which heavy metals appear in shilajit, what safe limits look like, how to read a heavy metals panel on a COA, and why some products fail testing."
      ...
      <div className="rounded-lg border border-[#252A40] bg-[#0F1320] p-6 md:p-8 space-y-8">
        ...
        <section className="space-y-4 text-sm text-[#8892B8] leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-[#EEF0F8] mt-6 mb-2">The Four Heavy Metals to Test For</h2>
            ...
            <table className="w-full text-xs">
              <thead className="bg-[#171C2E] border-b border-[#252A40]">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-[#8892B8]">USP limit (per day)</th>
                  <th className="text-left px-4 py-3 font-semibold text-[#8892B8]">CA Prop 65 limit</th>
                  <th className="text-left px-4 py-3 font-semibold text-[#8892B8]">Health concern</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#252A40]">
                <tr>
                  ...
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 0.5 µg/day</td>
                  <td className="px-4 py-3 text-[#8892B8]">Neurotoxic; no safe level for children; accumulates in bone</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-[#EEF0F8]">Arsenic (As)</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 15 µg/day</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 10 µg/day (inorganic)</td>
                  <td className="px-4 py-3 text-[#8892B8]">Carcinogenic (inorganic form); affects skin, lungs, bladder</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-[#EEF0F8]">Mercury (Hg)</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 15 µg/day</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 0.3 µg/day (methylmercury)</td>
                  <td className="px-4 py-3 text-[#8892B8]">Nephrotoxic and neurotoxic; methylmercury crosses blood-brain barrier</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-[#EEF0F8]">Cadmium (Cd)</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 5 µg/day</td>
                  <td className="px-4 py-3 text-[#8892B8]">&lt; 4.1 µg/day</td>
                  <td className="px-4 py-3 text-[#8892B8]">Accumulates in kidneys; biological half-life of 10–30 years</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-lg font-semibold text-[#EEF0F8] mt-6 mb-2">Purification: The Difference Between Safe and Unsafe</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#EEF0F8] mt-6 mb-2">FDA Warnings and Real-World Failures</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#EEF0F8] mt-6 mb-2">What "Claimed" vs. "Confirmed" Testing Means in Our Database</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#EEF0F8] mt-6 mb-2">Special Considerations: Pregnancy and Children</h2>
          <p>
