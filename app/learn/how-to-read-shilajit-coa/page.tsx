    ...
    <article className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-6 md:p-8 space-y-8">
        ...
        <section className="space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Step 1: Identify the Laboratory</h2>
          <p>
          ...
          <div className="rounded-xl bg-rose-50 border border-rose-200 p-4 mt-4">
            <p className="text-xs font-semibold text-rose-700 mb-1">🚩 Red flag</p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Step 2: Check the Sample Date</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Step 3: Find the Fulvic Acid Panel</h2>
          <p>
          ...
          <div className="rounded-xl bg-amber-50 border border-amber-200 p-4 mt-4">
            <p className="text-xs font-semibold text-amber-700 mb-1">⚠ Note on fulvic acid percentages</p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Step 4: Find the Heavy Metals Panel</h2>
          <p>
          ...
          <div className="rounded-xl border border-stone-200 overflow-hidden mt-2">
            <table className="w-full text-xs">
              <thead className="bg-stone-50 border-b border-stone-200">
                <tr>
                  <th className="text-left px-4 py-3 font-semibold text-stone-700">Metal</th>
                  <th className="text-left px-4 py-3 font-semibold text-stone-700">Safe limit (USP)</th>
                  <th className="text-left px-4 py-3 font-semibold text-stone-700">Why it matters</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-stone-100">
                <tr>
                  ...
                  <td className="px-4 py-3 text-stone-600">Neurotoxic; strict California Prop 65 limit of 0.5 µg/day</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-slate-800">Mercury (Hg)</td>
                  <td className="px-4 py-3 text-stone-600">&lt; 15 µg/day</td>
                  <td className="px-4 py-3 text-stone-600">Nephrotoxic; particularly dangerous in inorganic form</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-slate-800">Arsenic (As)</td>
                  <td className="px-4 py-3 text-stone-600">&lt; 15 µg/day</td>
                  <td className="px-4 py-3 text-stone-600">Inorganic arsenic is carcinogenic; organic forms less so</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium text-slate-800">Cadmium (Cd)</td>
                  <td className="px-4 py-3 text-stone-600">&lt; 5 µg/day</td>
                  <td className="px-4 py-3 text-stone-600">Accumulates in kidneys; long half-life</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p>
            See our full guide:{" "}
            <Link href="/learn/shilajit-heavy-metals" className="underline underline-offset-2 text-slate-900">
              Shilajit and Heavy Metals: Safety, Testing &amp; Acceptable Levels
            </Link>
            .
          </p>

          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Step 5: Microbial Testing</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Types of COA and What They Mean</h2>
          ...
          <h2 className="text-lg font-semibold text-slate-900 mt-6 mb-2">Verifying a COA</h2>
          <p>
        ...
        <div className="rounded-xl border border-stone-200 bg-stone-50 p-5">
          <p className="text-sm font-medium text-slate-900">Filter by COA status in our database</p>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Link href="/learn/shilajit-heavy-metals" className="group rounded-2xl border border-stone-200 bg-white p-5 hover:border-stone-300 hover:shadow-sm transition-all">
          ...
          <p className="text-sm font-semibold text-slate-900 group-hover:text-slate-700">Shilajit and Heavy Metals: Safety & Testing →</p>
        </Link>
