...
import { CoaStatusField } from "@/components/coa-status-field";
    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <form action={adminUpsertProduct} className="mt-6 space-y-5">
          ...
          <CoaStatusField
            initialStatus={product.coaStatus}
            initialUrl={product.coaUrl ?? ""}
            brandDomain={product.brand.websiteDomain ?? product.officialDomain ?? ""}
          />
