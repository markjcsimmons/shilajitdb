  ...
  return (
    <div className="space-y-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <div className="grid grid-cols-6 gap-0 border-b border-slate-200 bg-slate-50 px-5 py-3">
        ...
        <div className="divide-y divide-slate-200">
          {Array.from({ length: 12 }).map((_, i) => (
            <div key={i} className="grid grid-cols-6 gap-1 px-5 py-4 sm:items-center">
              <div className="col-span-2 h-4 w-32 animate-pulse rounded bg-slate-100" />
